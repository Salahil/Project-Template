...
var VERSION4 = new Version("19.2.9");
...
var AuthService = class _AuthService {
  constructor() {
    ...
    this.RESTAURANTE_ID_FUNCIONARIO_KEY = "restauranteIdFuncionario";
    this.USER_IMAGE_KEY = "imagemUsuario";
    this._token = null;
    this._perfil = null;
    this.BASE_IMAGE_URL = `${environment.apiUrl}`;
    ...
    const restauranteId = localStorage.getItem(this.RESTAURANTE_ID_FUNCIONARIO_KEY) || void 0;
    if (nome && tipo) {
      this._perfil = { nome, tipo, id, imagem, restauranteId };
    }
    console.log("[AuthService] Constructor - perfil inicial:", this._perfil);
  }
  setAuthData(token, nome, tipoUsuario, id, imagem, restauranteId) {
    this.setToken(token);
  ...
  getAbsoluteImageUrl(relativePath2) {
    if (relativePath2) {
      return `${this.BASE_IMAGE_URL}${relativePath2}`;
    }
    return "";
  }
  static {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-CSZAONZW.js.map
