import {
  NzMessageService
} from "./chunk-Y7YD3C5P.js";
import "./chunk-KEYB2N5R.js";
import {
...
var VerificacaoEmailComponent = class _VerificacaoEmailComponent {
  constructor(router, message, loginService, toastService) {
    this.router = router;
  ...
  irParaConfirmacao() {
    if (this.idVerificacao) {
      ...
      this.toastService.error("ID de verifica\xE7\xE3o n\xE3o encontrado. Tente fazer o cadastro novamente.");
    }
  }
  ngOnDestroy() {
    if (this.intervalId) {
  ...
  static {
    this.\u0275fac = function VerificacaoEmailComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _VerificacaoEmailComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(NzMessageService), \u0275\u0275directiveInject(AcessService), \u0275\u0275directiveInject(ToastrService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VerificacaoEmailComponent, selectors: [["app-verificacao-email"]], features: [\u0275\u0275ProvidersFeature([
      {
        provide: NZ_ICONS,
        useValue: [
          MailOutline,
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(20, "div", 14)(21, "div", 15)(22, "div", 16)(23, "div", 17);
        \u0275\u0275element(24, "i", 18);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(27, "div", 19);
        \u0275\u0275elementStart(28, "div", 20)(29, "div", 17);
        \u0275\u0275element(30, "i", 11);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(33, "div", 21);
        \u0275\u0275elementStart(34, "div", 22)(35, "div", 17);
        \u0275\u0275element(36, "i", 23);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275template(41, VerificacaoEmailComponent_span_41_Template, 3, 0, "span", 26)(42, VerificacaoEmailComponent_span_42_Template, 3, 1, "span", 26);
        \u0275\u0275elementEnd();
    ...
    }, dependencies: [CommonModule, NgIf, NzButtonModule, NzButtonComponent, NzTransitionPatchDirective, NzWaveDirective, NzIconModule, NzIconDirective, NzSpinModule, NzResultModule, DefaultLoginLayoutComponent], styles: ['\n\nhtml[_ngcontent-%COMP%], \nbody[_ngcontent-%COMP%] {\n  height: 100%;\n}\nbody[_ngcontent-%COMP%] {\n  background-color: var(--bg-page);\n  color: var(--text-primary);\n  font-family:\n    Inter,\n    system-ui,\n    -apple-system,\n    "Segoe UI",\n    Roboto,\n    "Helvetica Neue",\n    Arial;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n}\n.container[_ngcontent-%COMP%] {\n  max-width: 1100px;\n  margin: 0 auto;\n  padding: 0 16px;\n}\n.verificacao-email-content[_ngcontent-%COMP%] {\n  width: 100%;\n  max-width: 420px;\n  margin: 0 auto;\n  text-align: center;\n  padding: 28px 24px;\n}\n.main-icon[_ngcontent-%COMP%] {\n  margin-bottom: 2rem;\n}\n.main-icon[_ngcontent-%COMP%]   .icon-container[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 80px;\n  height: 80px;\n  background: var(--primary);\n  border-radius: 50%;\n  box-shadow: var(--shadow-md);\n}\n.main-icon[_ngcontent-%COMP%]   .icon-container[_ngcontent-%COMP%]   nz-icon[_ngcontent-%COMP%] {\n  font-size: 2.5rem;\n  color: var(--text-primary);\n}\n.header-content[_ngcontent-%COMP%] {\n  margin-bottom: 2rem;\n}\n.header-content[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  font-size: 1.5rem;\n  font-weight: 700;\n  color: var(--primary);\n  margin: 0 0 0.5rem 0;\n}\n.header-content[_ngcontent-%COMP%]   .subtitle[_ngcontent-%COMP%] {\n  font-size: 1rem;\n  color: var(--text-secondary);\n  margin: 0;\n}\n.email-info[_ngcontent-%COMP%] {\n  margin-bottom: 2rem;\n  padding: 1.25rem;\n  background: var(--bg-surface-elevated);\n  border-radius: var(--radius-lg);\n  border: 1px solid var(--border);\n}\n.email-info[_ngcontent-%COMP%]   .description[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n  font-size: 0.95rem;\n  margin: 0 0 1rem 0;\n}\n.email-info[_ngcontent-%COMP%]   .email-display[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n  padding: 0.75rem;\n  background: var(--border);\n  border-radius: var(--radius);\n  margin-bottom: 1rem;\n}\n.email-info[_ngcontent-%COMP%]   .email-address[_ngcontent-%COMP%] {\n  color: var(--primary);\n  font-weight: 600;\n  word-break: break-all;\n}\n.email-info[_ngcontent-%COMP%]   .instruction[_ngcontent-%COMP%] {\n  color: var(--text-muted);\n  font-size: 0.9rem;\n  margin: 0;\n}\n.email-illustration[_ngcontent-%COMP%] {\n  margin-bottom: 2rem;\n}\n.email-steps[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n  flex-wrap: wrap;\n}\n.step[_ngcontent-%COMP%], \n.step-line[_ngcontent-%COMP%] {\n  opacity: 0.6;\n}\n.step.active[_ngcontent-%COMP%], \n.step.completed[_ngcontent-%COMP%] {\n  opacity: 1;\n}\n.step-icon[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  background: var(--border);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: var(--text-secondary);\n}\n.step.active[_ngcontent-%COMP%]   .step-icon[_ngcontent-%COMP%] {\n  background: var(--primary);\n  color: var(--text-primary);\n}\n.step.completed[_ngcontent-%COMP%]   .step-icon[_ngcontent-%COMP%] {\n  background: var(--success);\n  color: #fff;\n}\n.step-line[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 2px;\n  background: var(--border);\n}\n.step-line.completed[_ngcontent-%COMP%] {\n  background: var(--success);\n}\n.step[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  color: var(--text-muted);\n}\n.success-indicator[_ngcontent-%COMP%] {\n  position: absolute;\n  top: -4px;\n  right: -4px;\n  width: 24px;\n  height: 24px;\n  background: var(--success);\n  border-radius: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #fff;\n}\n.icon-container[_ngcontent-%COMP%] {\n  position: relative;\n}\n.actions[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.actions[_ngcontent-%COMP%]   .primary-action[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 50px;\n  border: none;\n  border-radius: var(--radius);\n  background: var(--primary);\n  color: var(--text-primary);\n  font-weight: 600;\n  cursor: pointer;\n}\n.actions[_ngcontent-%COMP%]   .secondary-action[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 45px;\n  border: 1px solid var(--border-strong);\n  border-radius: var(--radius);\n  background: transparent;\n  color: var(--primary);\n  font-weight: 500;\n  cursor: pointer;\n}\n.help-section[_ngcontent-%COMP%] {\n  text-align: left;\n  padding: 1.25rem;\n  background: var(--bg-surface-elevated);\n  border-radius: var(--radius-lg);\n  border: 1px solid var(--border);\n}\n.help-section[_ngcontent-%COMP%]   .help-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  margin-bottom: 0.75rem;\n  color: var(--primary);\n  font-weight: 600;\n}\n.help-section[_ngcontent-%COMP%]   .help-list[_ngcontent-%COMP%] {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n.help-section[_ngcontent-%COMP%]   .help-list[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n  font-size: 0.9rem;\n  margin-bottom: 0.5rem;\n}\n.help-section[_ngcontent-%COMP%]   .back-link[_ngcontent-%COMP%] {\n  color: var(--primary);\n  background: none;\n  border: none;\n  padding: 0;\n  cursor: pointer;\n}\n@media (max-width: 480px) {\n  .header-content[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n    font-size: 1.35rem;\n  }\n  .help-section[_ngcontent-%COMP%] {\n    padding: 1rem;\n  }\n}\n/*# sourceMappingURL=verificacao-email.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(VerificacaoEmailComponent, [{
    type: Component,
    args: [{ selector: "app-verificacao-email", standalone: true, imports: [CommonModule, NzButtonModule, NzIconModule, NzSpinModule, NzResultModule, DefaultLoginLayoutComponent], providers: [
      {
        provide: NZ_ICONS,
        useValue: [
          MailOutline,
